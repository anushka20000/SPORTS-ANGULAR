...
@Component({
  selector: 'app-group-club',
  templateUrl: './group_club.component.html',
})
export class GroupClubComponent {
...
onEditFormClose() {
  ...
  private loadGrid() {
    let url = `${environment.apiUrl}/admin/league-group-clubs/${this.leagueId}`;
