...
export class ClubService {
  ...
  store(artistObj: Object){
    return this.http.post<any>(this.baseURL+'api/TopChart', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
  }
  storeSubscription(artistObj: Object){
    return this.http.post<any>(this.baseURL+'api/admin-apply-subscription', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
  ...
  updateOrder(artistObj: Object){
    return this.http.post<any>(this.baseURL+'api/admin-update-order', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
  ...
  storeExtendSubscription(artistObj: Object){
    return this.http.post<any>(this.baseURL+'api/admin-change-subscription-day', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
...
//   }
  ...
  addClub(artistObj: Object){
    return this.http.post<any>(this.baseURL+'/admin/club/store', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
  }
  editClub(artistObj: Object){
    return this.http.put<any>(this.baseURL+'/admin/club/update', artistObj)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
  ...
  destroyClub(id: number){
    return this.http.delete<any>(this.baseURL+'/admin/club/delete/' + id)
      .pipe(map((res:any) => {
        return res;
        // login successful if there's a jwt token in the response
      }));
